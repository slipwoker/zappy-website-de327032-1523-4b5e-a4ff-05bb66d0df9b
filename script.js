document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showFormError(form) {
      const existingMsg = form.querySelector('.form-general-error');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'de327032-1523-4b5e-a4ff-05bb66d0df9b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'de327032-1523-4b5e-a4ff-05bb66d0df9b';
...
(function () {
  // FAQ Accordion
  var faqItems = document.querySelectorAll('.smart-locks-section .faq-item');
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'de327032-1523-4b5e-a4ff-05bb66d0df9b';
